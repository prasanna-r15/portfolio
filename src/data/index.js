...
export const achievements = [
  { label: 'Years Experience', value: '4+', mark: 'YE', color: '#9A5B3F' },
  { label: 'Products Built', value: '4+', mark: 'PB', color: '#B5794A' },
  { label: 'Banking Integrations', value: '5+', mark: 'BI', color: '#69724D' },
  { label: 'Core Technologies', value: '20+', mark: 'CT', color: '#C38B59' },
];
